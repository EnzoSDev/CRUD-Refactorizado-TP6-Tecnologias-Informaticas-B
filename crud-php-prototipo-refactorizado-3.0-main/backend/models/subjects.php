...
function getSubjectByName($conn, $name){
    ...
    $stmt->execute();
    $result = $stmt->get_result();
    return $result->fetch_assoc(); /* Get_result obtiene el objeto mysqli_result y fetch_assoc obtiene la primera fila (En este caso unica) en forma de array asociativo */
}
